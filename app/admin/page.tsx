    ...
    return (
        <ArchiveLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <Link href="/admin/anomalies" className="group bg-white border-2 border-slate-900 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                    <h2 className="text-2xl font-black mb-4 uppercase tracking-tight group-hover:text-blue-700">Anomalies Manager &rarr;</h2>
                    <p className="text-slate-600 font-sans leading-relaxed">
                        Identify and resolve inconsistent game data, update scores, or delete invalid entries.
                    </p>
                </Link>

                <Link href="/admin/game-counts" className="group bg-white border-2 border-slate-900 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                    <h2 className="text-2xl font-black mb-4 uppercase tracking-tight group-hover:text-blue-700">Game Count Validator &rarr;</h2>
                    <p className="text-slate-600 font-sans leading-relaxed">
                        Review phases where teams have played more or fewer games than expected.
                    </p>
                </Link>
